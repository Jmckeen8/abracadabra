...
Shader "S_ParticleAdd"
{
	Properties
	{
		...
		[ASEBegin][Enum(UnityEngine.Rendering.BlendMode)]_Add_Blend("Add_Blend", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			CBUFFER_END
			sampler2D _MainTex;
			sampler2D _NoiseMainTex;
			sampler2D _AlphaMask;
			sampler2D _NoiseAlphaMask;
			sampler2D _SubAlphaMask;
						 ...
						 ) : SV_Target
			{
				...
				float4 texCoord58 = IN.ase_texcoord8;
				texCoord58.xy = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				float ControlMoveMainTexByU60 = texCoord58.w;
				...
				float2 uv_NoiseMainTex = IN.ase_texcoord9.xy * _NoiseMainTex_ST.xy + _NoiseMainTex_ST.zw;
				...
				float ControlMoveAlphaByU59 = texCoord58.z;
				float2 appendResult64 = (float2(0.0 , ControlMoveAlphaByU59));
				float2 uv_AlphaMask = IN.ase_texcoord9.xy * _AlphaMask_ST.xy + _AlphaMask_ST.zw;
				...
				float2 uv_SubAlphaMask = IN.ase_texcoord9.xy * _SubAlphaMask_ST.xy + _SubAlphaMask_ST.zw;
				float2 panner30 = ( 1.0 * _Time.y * _SpeedDirSubAlphaMask + uv_SubAlphaMask);
				
				float3 Albedo = float3(0.5, 0.5, 0.5);
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( lerpResult56 * IN.ase_color ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = 0.5;
				float Occlusion = 1;
				float Alpha = ( tex2D( _AlphaMask, ( float4( appendResult64, 0.0 , 0.0 ) + ( float4( panner18, 0.0 , 0.0 ) + ( _NoiseAlphaMaskStrength * tex2D( _NoiseAlphaMask, panner23 ) ) ) ).rg ) * tex2D( _SubAlphaMask, panner30 ) * IN.ase_color.a ).r;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float4 texCoord58 = IN.ase_texcoord2;
				texCoord58.xy = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float ControlMoveAlphaByU59 = texCoord58.z;
				float2 appendResult64 = (float2(0.0 , ControlMoveAlphaByU59));
				float2 uv_AlphaMask = IN.ase_texcoord3.xy * _AlphaMask_ST.xy + _AlphaMask_ST.zw;
				float2 panner18 = ( 1.0 * _Time.y * _SpeedDirAlphaMask + uv_AlphaMask);
				float2 panner23 = ( 1.0 * _Time.y * _SpeedDirNoiseAlphaMask + uv_AlphaMask);
				float2 uv_SubAlphaMask = IN.ase_texcoord3.xy * _SubAlphaMask_ST.xy + _SubAlphaMask_ST.zw;
				float2 panner30 = ( 1.0 * _Time.y * _SpeedDirSubAlphaMask + uv_SubAlphaMask);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 texCoord58 = IN.ase_texcoord4;
				texCoord58.xy = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float ControlMoveMainTexByU60 = texCoord58.w;
				float2 appendResult69 = (float2(0.0 , ControlMoveMainTexByU60));
				float2 uv_MainTex = IN.ase_texcoord5.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float2 panner6 = ( 1.0 * _Time.y * _SpeedDirMainTex + uv_MainTex);
				float2 uv_NoiseMainTex = IN.ase_texcoord5.xy * _NoiseMainTex_ST.xy + _NoiseMainTex_ST.zw;
				float2 panner11 = ( 1.0 * _Time.y * _SpeedDirNoiseMainTex + uv_NoiseMainTex);
				float4 lerpResult56 = lerp( _Tint_01 , _Tint_02 , tex2D( _MainTex, ( appendResult69 + ( panner6 + ( _NoiseStrengthMainTex * tex2D( _NoiseMainTex, panner11 ).r ) ) ) ));
				
				float ControlMoveAlphaByU59 = texCoord58.z;
				float2 appendResult64 = (float2(0.0 , ControlMoveAlphaByU59));
				float2 uv_AlphaMask = IN.ase_texcoord5.xy * _AlphaMask_ST.xy + _AlphaMask_ST.zw;
				float2 panner18 = ( 1.0 * _Time.y * _SpeedDirAlphaMask + uv_AlphaMask);
				float2 panner23 = ( 1.0 * _Time.y * _SpeedDirNoiseAlphaMask + uv_AlphaMask);
				float2 uv_SubAlphaMask = IN.ase_texcoord5.xy * _SubAlphaMask_ST.xy + _SubAlphaMask_ST.zw;
				float2 panner30 = ( 1.0 * _Time.y * _SpeedDirSubAlphaMask + uv_SubAlphaMask);
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 texCoord58 = IN.ase_texcoord;
				texCoord58.xy = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float ControlMoveAlphaByU59 = texCoord58.z;
				float2 appendResult64 = (float2(0.0 , ControlMoveAlphaByU59));
				float2 uv_AlphaMask = IN.ase_texcoord1.xy * _AlphaMask_ST.xy + _AlphaMask_ST.zw;
				float2 panner18 = ( 1.0 * _Time.y * _SpeedDirAlphaMask + uv_AlphaMask);
				float2 panner23 = ( 1.0 * _Time.y * _SpeedDirNoiseAlphaMask + uv_AlphaMask);
				float2 uv_SubAlphaMask = IN.ase_texcoord1.xy * _SubAlphaMask_ST.xy + _SubAlphaMask_ST.zw;
				float2 panner30 = ( 1.0 * _Time.y * _SpeedDirSubAlphaMask + uv_SubAlphaMask);
				
				surfaceDescription.Alpha = ( tex2D( _AlphaMask, ( float4( appendResult64, 0.0 , 0.0 ) + ( float4( panner18, 0.0 , 0.0 ) + ( _NoiseAlphaMaskStrength * tex2D( _NoiseAlphaMask, panner23 ) ) ) ).rg ) * tex2D( _SubAlphaMask, panner30 ) * IN.ase_color.a ).r;
...
/*ASEBEGIN
Version=18935
1706.667;-280;1920;1019;-88.01843;-19.70127;1.392003;True;False
...
Node;AmplifyShaderEditor.Vector2Node;25;-430.702,1357.192;Inherit;False;Property;_SpeedDirNoiseAlphaMask;Speed Dir Noise Alpha Mask;12;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;22;-44.04284,1044.512;Inherit;False;Property;_NoiseAlphaMaskStrength;Noise Alpha Mask Strength;11;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;20;41.92786,1227.621;Inherit;True;Property;_NoiseAlphaMask;Noise Alpha Mask;10;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;17;36.43678,848.9495;Inherit;False;Property;_SpeedDirAlphaMask;Speed Dir Alpha Mask;9;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;28;734.2374,1237.974;Inherit;False;Property;_SpeedDirSubAlphaMask;Speed Dir Sub Alpha Mask;14;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;27;1320.549,1111.123;Inherit;True;Property;_SubAlphaMask;Sub Alpha Mask;13;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;15;921.4925,777.1282;Inherit;True;Property;_AlphaMask;Alpha Mask;8;0;Create;True;0;0;0;False;0;False;-1;abaf76e832f6c744d8e610c661b33c5e;109be7e9c04d99b4581dbeaa645ec828;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;7;-358.8156,193.7596;Inherit;False;Property;_SpeedDirMainTex;Speed Dir MainTex;4;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;3;468.3255,68.57934;Inherit;True;Property;_MainTex;MainTex;3;0;Create;True;0;0;0;False;0;False;-1;None;109be7e9c04d99b4581dbeaa645ec828;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;14;-387.4221,345.9073;Inherit;False;Property;_NoiseStrengthMainTex;Noise Strength MainTex;6;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;12;-967.448,583.5347;Inherit;False;Property;_SpeedDirNoiseMainTex;Speed Dir Noise MainTex;7;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;9;-436.8305,468.2125;Inherit;True;Property;_NoiseMainTex;Noise MainTex;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;57;1170.247,-3.923715;Inherit;False;Property;_Tint_02;Tint_02;2;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;7.464264,7.464264,7.464264,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;70;326.8078,2116.479;Inherit;False;Property;_CullMode;CullMode;15;1;[Enum];Create;True;0;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1;1169.105,-222.6952;Inherit;False;Property;_Tint_01;Tint_01;1;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;223;2;2;0
WireConnection;223;6;31;0
ASEEND*/
//CHKSM=D941555AABE76C1E1C3043041F39BCBC3CEBF301